...
import { validateProductCreate, validateProductUpdate } from "./productValidators.js"
...
router.post("/", roleMiddleware(["admin"]), validateProductCreate, (req, res) => proeducController.createProduct(req, res))
router.put("/:id", roleMiddleware(["admin"]), validateProductUpdate, (req, res) => proeducController.updateProduct(req, res))
